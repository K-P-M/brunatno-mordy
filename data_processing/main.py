...
def load_chunks():
    ...
    with open('../data_harvesting/data_cleaning/chunked_all.jsonl', 'r', encoding='utf-8') as file:
        for line in file:
...
if __name__ == "__main__":
    ...
    with open('train_datasets/descriptions_instruct.jsonl', 'w', encoding='utf-8') as file:
